...
public class NewsEntertainmentFull extends AppCompatActivity implements GestureDetector.OnDoubleTapListener,GestureDetector.OnGestureListener {
    ...
    private void getdesc(String in) {
        DatabaseReference mdesc = FirebaseDatabase.getInstance().getReference().child("Entertainment").child(in).child("content").child("des");
