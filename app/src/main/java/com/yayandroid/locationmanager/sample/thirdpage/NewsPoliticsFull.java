...
public class NewsPoliticsFull extends AppCompatActivity implements GestureDetector.OnDoubleTapListener,GestureDetector.OnGestureListener {
    ...
    private void getdesc(String in) {
        DatabaseReference mdesc = FirebaseDatabase.getInstance().getReference().child("Politics").child(in).child("content").child("des");
