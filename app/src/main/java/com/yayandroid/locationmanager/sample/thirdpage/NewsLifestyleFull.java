...
public class NewsLifestyleFull extends AppCompatActivity implements GestureDetector.OnDoubleTapListener,GestureDetector.OnGestureListener {
    ...
    private void getdesc(String in) {
        DatabaseReference mdesc = FirebaseDatabase.getInstance().getReference().child("Lifestyle").child(in).child("content").child("des");
